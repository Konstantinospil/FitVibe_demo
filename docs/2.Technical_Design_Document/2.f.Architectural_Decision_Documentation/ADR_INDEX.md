...
| ADR-030 | User Preference Ownership and Locale Separation                                                  | Accepted | 2026-09-24    | [ADR-030-user-preference-ownership.md](./ADR-030-user-preference-ownership.md)                             |
...
- ADR-030 records the Phase 9 ownership boundary between explicit language/measurement preferences and locale.
