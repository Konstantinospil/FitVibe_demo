...
- [US-6.5-AC01](../acceptance-criteria/US-6.5-AC01.md): GDPR event audit logging
- [US-6.5-AC02](../acceptance-criteria/US-6.5-AC02.md): Audit log retention and search

## Dependencies

### Story Dependencies

- [US-6.1: Data Export](../user-stories/US-6.1-data-export.md): Export events
- [US-6.2: Account Deletion](../user-stories/US-6.2-account-deletion.md): Deletion events
- [US-6.3: Consent Management](../user-stories/US-6.3-consent-management.md): Consent events
