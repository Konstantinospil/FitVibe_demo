...
- [US-5.2-AC01](../acceptance-criteria/US-5.2-AC01.md): GPX file import
- [US-5.2-AC02](../acceptance-criteria/US-5.2-AC02.md): GPX parser robustness
- [US-5.2-AC03](../acceptance-criteria/US-5.2-AC03.md): Imported data creation

## Dependencies

### Story Dependencies

- [US-5.1: Manual Logging](../user-stories/US-5.1-manual-logging.md): Session creation
