...
- [US-2.5-AC01](../acceptance-criteria/US-2.5-AC01.md): Exercise selector display
- [US-2.5-AC02](../acceptance-criteria/US-2.5-AC02.md): Exercise selector search
...
- [US-2.2: Exercise Search](../user-stories/US-2.2-exercise-search.md): Search functionality
- [FR-004: Planner](../requirements/FR-004-planner.md): Used in planner
- [FR-005: Logging & Import](../requirements/FR-005-logging-and-import.md): Used in logger
