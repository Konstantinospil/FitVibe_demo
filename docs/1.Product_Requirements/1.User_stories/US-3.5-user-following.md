...
- [US-3.5-AC01](../acceptance-criteria/US-3.5-AC01.md): Follow/unfollow functionality
- [US-3.5-AC02](../acceptance-criteria/US-3.5-AC02.md): Follower counts
- [US-3.5-AC03](../acceptance-criteria/US-3.5-AC03.md): Follow rate limiting

## Dependencies

### Feature Dependencies

- [FR-009: Profile & Settings](../requirements/FR-009-profile-and-settings.md): User profiles required
