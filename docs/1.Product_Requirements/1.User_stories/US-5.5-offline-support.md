...
- [US-5.5-AC01](../acceptance-criteria/US-5.5-AC01.md): Offline logging and sync
- [US-5.5-AC02](../acceptance-criteria/US-5.5-AC02.md): Service worker and retry logic

## Dependencies

### Story Dependencies

- [US-5.1: Manual Logging](../user-stories/US-5.1-manual-logging.md): Session logging
