...
- [US-3.2-AC01](../acceptance-criteria/US-3.2-AC01.md): Visibility toggle
- [US-3.2-AC02](../acceptance-criteria/US-3.2-AC02.md): Privacy protection

## Dependencies

### Story Dependencies

- [US-3.1: Public Feed](../user-stories/US-3.1-public-feed.md): Feed must exist
