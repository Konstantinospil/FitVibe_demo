...
- [US-4.2-AC01](../acceptance-criteria/US-4.2-AC01.md): Plan activation
- [US-4.2-AC02](../acceptance-criteria/US-4.2-AC02.md): Progress tracking
- [US-4.2-AC03](../acceptance-criteria/US-4.2-AC03.md): Plan duration validation

## Dependencies

### Story Dependencies

- [US-4.1: Plan CRUD](../user-stories/US-4.1-plan-crud.md): Plans must exist before activation
