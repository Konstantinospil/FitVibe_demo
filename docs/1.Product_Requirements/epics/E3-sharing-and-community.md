...
**Epic ID**: E3  
**Requirement ID**: [FR-011](../requirements/FR-011-sharing-and-community.md)  
...
- [US-3.1: Public Feed](../user-stories/US-3.1-public-feed.md)
- [US-3.2: Session Visibility](../user-stories/US-3.2-session-visibility.md)
- [US-3.3: Likes & Bookmarks](../user-stories/US-3.3-likes-bookmarks.md)
- [US-3.4: Comments](../user-stories/US-3.4-comments.md)
- [US-3.5: User Following](../user-stories/US-3.5-user-following.md)
- [US-3.6: Session Cloning](../user-stories/US-3.6-session-cloning.md)
- [US-3.7: Content Reporting](../user-stories/US-3.7-content-reporting.md)
- [US-3.8: Social Testing](../user-stories/US-3.8-social-testing.md)

## Dependencies

### Epic Dependencies

- [FR-011: Sharing & Community](../requirements/FR-011-sharing-and-community.md): Parent requirement
...
- [FR-004: Planner](../requirements/FR-004-planner.md): Session planning and cloning
- [FR-008: Admin & RBAC](../requirements/FR-008-admin-and-rbac.md): Content moderation
- [FR-009: Profile & Settings](../requirements/FR-009-profile-and-settings.md): User profiles and following
- [NFR-002: Privacy](../requirements/NFR-002-privacy.md): Privacy controls
