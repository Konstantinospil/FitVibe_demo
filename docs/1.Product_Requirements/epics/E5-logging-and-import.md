...
**Epic ID**: E5  
**Requirement ID**: [FR-005](../requirements/FR-005-logging-and-import.md)  
...
- [US-5.1: Manual Logging](../user-stories/US-5.1-manual-logging.md)
- [US-5.2: GPX Import](../user-stories/US-5.2-gpx-import.md)
- [US-5.3: FIT Import](../user-stories/US-5.3-fit-import.md)
- [US-5.4: Metric Calculation](../user-stories/US-5.4-metric-calculation.md)
- [US-5.5: Offline Support](../user-stories/US-5.5-offline-support.md)
- [US-5.6: Import Testing](../user-stories/US-5.6-import-testing.md)

## Dependencies

### Epic Dependencies

- [FR-005: Logging & Import](../requirements/FR-005-logging-and-import.md): Parent requirement
...
- [FR-004: Planner](../requirements/FR-004-planner.md): Session planning
