import type { DeleteSchedule } from "../../../../apps/backend/src/modules/dsr.service.js";
import { insertAudit } from "../../../../apps/backend/src/modules/common/audit.util.js";
import { deleteStorageObject } from "../../../../apps/backend/src/services/mediaStorage.service.js";
...
beforeAll(async () => {
  const mod = await import("../../../../apps/backend/src/modules/users/dsr.service.js");
