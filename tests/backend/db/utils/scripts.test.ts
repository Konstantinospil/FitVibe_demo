...
jest.mock("../../../../apps/backend/src/utils/error.utils.js", () => ({
...
describe("backupDatabase", () => {
  it("logs success when pg_dump succeeds", async () => {
    ...
    await jest.isolateModulesAsync(async () => {
      await import("../../../../apps/backend/src/db/utils/backupDatabase.js");
    });
...
describe("migration & seed scripts", () => {
  it("applies migrations and destroys the connection", async () => {
    await jest.isolateModulesAsync(async () => {
      await import("../../../../apps/backend/src/db/utils/migrateAll.js");
  ...
  it("rolls back all migrations when requested", async () => {
    await jest.isolateModulesAsync(async () => {
      await import("../../../../apps/backend/src/db/utils/rollbackAll.js");
      await flushPromises();
    });
  ...
  it("runs all seeds successfully", async () => {
    await jest.isolateModulesAsync(async () => {
      await import("../../../../apps/backend/src/db/utils/seedAll.js");
      await flushPromises();
    });
...
describe("postDeploy tasks", () => {
  it("ensures partitions and refreshes views", async () => {
    await jest.isolateModulesAsync(async () => {
      await import("../../../../apps/backend/src/db/utils/postDeploy.js");
      await flushPromises();
    });
...
describe("verifyIntegrity script", () => {
  it("checks every table and view then closes the connection", async () => {
    await jest.isolateModulesAsync(async () => {
      await import("../../../../apps/backend/src/db/utils/verifyIntegrity.js");
      await flushPromises();
    });
...
describe("db utils barrel module", () => {
  it("re-exports individual utility modules", async () => {
    await jest.isolateModulesAsync(async () => {
      jest.doMock("../../../../apps/backend/src/db/utils/backupDatabase.js", () => ({
        __esModule: true,
        backupSentinel: true,
      }));
      jest.doMock("../../../../apps/backend/src/db/utils/migrateAll.js", () => ({
        __esModule: true,
        migrateSentinel: true,
      }));
      jest.doMock("../../../../apps/backend/src/db/utils/postDeploy.js", () => ({
        __esModule: true,
        postDeploySentinel: true,
      }));
      jest.doMock("../../../../apps/backend/src/db/utils/rollbackAll.js", () => ({
        __esModule: true,
        rollbackSentinel: true,
      }));
      jest.doMock("../../../../apps/backend/src/db/utils/seedAll.js", () => ({
        __esModule: true,
        seedSentinel: true,
      }));
      jest.doMock("../../../../apps/backend/src/db/utils/verifyIntegrity.js", () => ({
        __esModule: true,
        verifySentinel: true,
      }));

      const exports = await import("../../../../apps/backend/src/db/utils/index.js");
      ...
      jest.dontMock("../../../../apps/backend/src/db/utils/backupDatabase.js");
      jest.dontMock("../../../../apps/backend/src/db/utils/migrateAll.js");
      jest.dontMock("../../../../apps/backend/src/db/utils/postDeploy.js");
      jest.dontMock("../../../../apps/backend/src/db/utils/rollbackAll.js");
      jest.dontMock("../../../../apps/backend/src/db/utils/seedAll.js");
      jest.dontMock("../../../../apps/backend/src/db/utils/verifyIntegrity.js");
    });
  });
});
