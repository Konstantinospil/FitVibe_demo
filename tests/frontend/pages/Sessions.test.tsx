  ...
  resources: {
    en: {
      translation: {
        ...
        "sessions.noPlanned": "No planned sessions",
        "sessions.createFirst": "Create your first workout session to get started",
        "sessions.exercise": "exercise",
        "sessions.exercises": "exercises",
        "sessions.more": "more",
        "sessions.startSession": "Start session",
        "sessions.viewSession": "View session",
        "sessions.deleteSession": "Delete session",
        "sessions.deleteConfirmTitle": "Delete Session",
        "sessions.deleteConfirmMessage": "Are you sure you want to delete this session?",
        "sessions.deleteConfirmLabel": "Yes, Delete Session",
        "sessions.deleteSuccess": "Session deleted successfully",
        "sessions.deleteError": "Failed to delete session. Please try again.",
        "sessions.noActive": "No active sessions",
        "sessions.startFromPlanner": "Start one from the planner to begin tracking.",
        "sessions.goToPlanner": "Go to Planner",
        "sessions.statusPlanned": "Planned",
        "sessions.statusInProgress": "In Progress",
        "sessions.untitled": "Untitled Session",
        "sessions.customExercise": "Custom Exercise",
        "sessions.started": "Started",
        "sessions.recently": "recently",
