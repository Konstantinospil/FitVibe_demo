import * as exerciseTypesService from "../exerciseTypes.service.js";
import * as exerciseTypesRepository from "../exerciseTypes.repository.js";
import * as auditUtil from "../../common/audit.util.js";
import type { ExerciseType } from "../exerciseTypes.types.js";

// Mock dependencies
jest.mock("../exerciseTypes.repository.js");
