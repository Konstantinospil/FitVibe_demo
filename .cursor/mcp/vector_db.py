...
# Sanitization utility (inline to avoid external dependency)
...
class VectorDB:
    ...
    def search(
        ...
        # Apply sanitization to all results before returning
        sanitized_results = sanitize_search_results(
            processed_results,
    ...
    def search_by_category(
        ...
        if query:
            ...
            # Apply sanitization to category results
            sanitized_results = sanitize_search_results(
                processed_results,
