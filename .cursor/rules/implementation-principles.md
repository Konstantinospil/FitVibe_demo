...
1. **Create API endpoints** (83 requests) - See "Backend Route Handler Pattern" in `implementation-patterns.md`
2. **Create database migrations** (42 requests) - See "Database Migration Pattern" in `implementation-patterns.md`
3. **Create/update tests** (40 requests) - See "Testing Patterns" in `implementation-patterns.md`
4. **Update existing code** (32 requests) - Follow existing patterns, maintain consistency
5. **Create React components** (14 requests) - See "Frontend Component Pattern" in `implementation-patterns.md`
