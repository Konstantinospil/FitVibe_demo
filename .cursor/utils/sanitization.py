...
class TaintLevel(Enum):
    ...
    SYSTEM = "SYSTEM"  # ✓SYSTEM - Generated by system/agent
    EXTERNAL = "EXTERNAL"  # ⚠️EXTERNAL - Retrieved from external source
    SEARCH = "SEARCH"  # 🔍SEARCH - Retrieved from search/knowledge base
    USER = "USER"  # 👤USER - User-provided input
...
class TaintedString:
    ...
    def __str__(self) -> str:
        ...
        markers = {
            TaintLevel.SYSTEM: "✓SYSTEM",
            TaintLevel.EXTERNAL: "⚠️EXTERNAL",
            TaintLevel.SEARCH: "🔍SEARCH",
            TaintLevel.USER: "👤USER",
        }
