...
- **Fix Proposals**: `.cursor/bug-database/brainstorm-results.json`
  - Consensus solution
...
📁 Saved 1 fix proposals to: .cursor/bug-database/brainstorm-results.json
```
...
```bash
# View all proposals
cat .cursor/bug-database/brainstorm-results.json | jq '.'

# View consensus for first bug
cat .cursor/bug-database/brainstorm-results.json | jq '.[0].consensus'

# View all perspectives
cat .cursor/bug-database/brainstorm-results.json | jq '.[0].allPerspectives'
```
...
3. **Review proposals**: Check `.cursor/bug-database/brainstorm-results.json`
