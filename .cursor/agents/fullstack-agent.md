...
4. Write tests at all layers (unit, integration, E2E)
5. Consider security implications at every layer
6. Ensure accessibility in frontend
7. Optimize database queries
8. Follow monorepo workspace conventions
